    ...
    <body @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl" @endif>
        ...
        <header class="main-header header-style-1 font-heading">
            @if (is_plugin_active('language'))
                <div class="header-select-language d-none /*d-block d-sm-none*/">
                    <div class="container">
...
<gecko-coin-price-marquee-widget locale="en" outlined="true" coin-ids="ethereum,solana,bitcoin,cardano,ripple,dogecoin,binancecoin,vice-2,bittensor,keeta,hyperliquid,sui,mixie,apecoin,cetus-protocol" initial-currency="usd"></gecko-coin-price-marquee-widget>
                        ...
                        <div class="col-12 align-self-center main-search-form-cover m-auto">
                            ...
                            <form action="{{ is_plugin_active('blog') ? route('public.search') : '#' }}" class="search-header">
                                <div class="input-group w-100">
                                    <!--<input type="text" name="q" id="searchInput" class="form-control" placeholder="{{ __('search.placeholder.1') }}">-->
                                    <input type="text" name="q" class="form-control" placeholder="{{ __('Search notes, systems and slow thoughts') }}">
