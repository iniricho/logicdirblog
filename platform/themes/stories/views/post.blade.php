        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right d-none d-md-inline">
                <ul class="header-social-network d-inline-block list-inline mr-15">
                    ...
                    <li class="list-inline-item"><a class="social-icon tw text-xs-center" target="_blank" href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ $post->description }}"><img src="https://cdn.simpleicons.org/x/ffffff" width="12" alt="X logo"></a></li>
    ...
    <article class="entry-wraper mb-50">
        ...
        <div class="single-social-share clearfix wow fadeIn  animated" style="visibility: visible; animation-name: fadeIn;">
            <ul class="header-social-network d-inline-block list-inline float-md-right mt-md-0 mt-4">
                ...
                <li class="list-inline-item"><a class="social-icon tw text-xs-center" target="_blank" href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ strip_tags(SeoHelper::getDescription()) }}"><img src="https://cdn.simpleicons.org/x/ffffff" width="12" alt="X logo"></a></li>
                                ...
                                <div class="col-md-4">
                                    <div class="post-thumb position-relative border-radius-5">
                                        ...
                                        <ul class="social-share">
                                            ...
                                            <li><a class="tw" href="https://twitter.com/intent/tweet?url={{ urlencode($relatedItem->url) }}&text={{ $relatedItem->description }}" target="_blank" title="{{ __('Tweet now') }}"><img src="https://cdn.simpleicons.org/x/ffffff" width="12" alt="X logo"></a></li>
